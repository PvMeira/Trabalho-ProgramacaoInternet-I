...
<?php
	...
	$resultado1=mysql_query("Select * from employee where id = '$cod'") or die ("<div class='alert alert-danger' role='alert'>Não é possível retornar dados do Funcioanrio!</div>");
